  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <AndalusLogo size={64} color={T.isDark ? '#fff' : T.accent} />
      ...
      <div style={{ padding: '0 16px 32px', display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        {banners.map((b, i) => (
          <div key={b.id} style={{
            ...
            <AndalusLogo size={22} color={T.isDark ? '#fff' : T.accent} />
            <div style={{ flex: 1, minWidth: 0 }}>
